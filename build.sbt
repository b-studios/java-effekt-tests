...
lazy val effektVersion = "0.1.1-SNAPSHOT"
...
lazy val effektSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    "de.b-studios" %% s"${effekt}-core" % effektVersion,
    "de.b-studios" %% s"${effekt}-instrumentation" % effektVersion
  ),

  // java agent that performs the instrumentation
  javaAgents += JavaAgent("de.b-studios" % s"${effekt}-instrumentation_2.12" % effektVersion % "compile;test;run"),
